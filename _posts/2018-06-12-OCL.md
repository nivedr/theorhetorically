...
When is a sublinear (in $$T$$) regret bound attainable? Zinkevich shows that one can attain a regret bound of $$\Omega(\sqrt{T})$$ using a very simple greedy projection algorithm:
```
