...
This blog post discusses some aspects of Martin Zinkevich's 2003 paper [Online Convex Programming and Generalized Infinitesimal Gradient Ascent](https://people.eecs.berkeley.edu/~brecht/cs294docs/week1/03.Zinkevich.pdf){:target="_blank"}.

The Online Convex Programming framework introduced in Zinkevich's 2003 paper models a wide range of "decision-under-uncertainty" optimization problems. As the name suggests, OCP is a natural online extension of convex optimization.
...
\begin{equation\*}
x_{t+1} \leftarrow P_D (y_{t+1}),\quad \text{where} \quad y_{t+1} \leftarrow y_t - \eta_t (\nabla g_t) (x_t)
\end{equation\*}
