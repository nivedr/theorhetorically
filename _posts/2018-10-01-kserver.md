...
&\overset{(ii)}{\ge} \mathbb{E}\_{Y \sim P\_{HST}} \frac{1}{\mathrm{Comp}\_{\mathrm{Alg}\_1}} \mathbb{E}\_{\mathrm{Alg}\_1} \mathrm{Cost}\_{\mathrm{Alg}\_1}^{Y}
\end{align}
